...
export default function TopNavbarComponent({ setSearchVal }) {
    ...
    <div className="flex justify-between items-center ">
      ...
      <div className="h-16 rounded-xl w-2/12 bg-white py-2.5 px-3 flex gap-3 items-start">
        ...
        <div className="flex flex-col overflow-hidden">
          <p className="capitalize text-base truncate">dark moon</p>
          <p className="text-gray-400 text-sm truncate">darkmoon@gmail.com</p>
        </div>
      </div>
    </div>
  );
